...
const Footer = ({ blog, location, twitter, company }: IFooter) => {
  return (
    <footer className="grid grid-cols-1 mx-6 mb-6 xl:ml-48 lg:ml-36">
      ...
      <div className="grid gap-x-6 md:grid-cols-2 grid-cols-1">
        ...
        >
          ...
          <p className="px-2 hover:underline hover:cursor-pointer transition ease-in-out duration-700 overflow-ellipsis overflow-hidden">
