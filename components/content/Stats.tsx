...
const Stats = ({ repos, followers, following }: IStats) => {
  return (
    <div className="flex flex-row justify-between md:items-center md:px-10 px-4 h-[85px] bg-lm-light-grey dark:bg-dm-black-blue mx-6 mb-10 xl:ml-48 lg:ml-36 rounded-xl shadow-xl">
