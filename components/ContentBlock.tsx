  ...
  return (
    <div className="rounded-xl flex flex-col md:justify-between lg:items-end md:items-start sm:items-start items-start bg-lm-white dark:bg-dm-blue shadow-xl mb-6 md:mb-0">
      ...
      <div className="flex flex-row items-end w-full">
        <div className="mt-10 ml-4 2xl:w-1/5 xl:w-1/5 lg:w-1/6 md:0/6 w-0/6" />
      ...
      <div className="flex flex-row items-end w-full">
        <div className="mt-10 ml-4 2xl:w-1/5 xl:w-1/5 lg:w-1/6 md:1/6 w-0/6" />
        <Stats
      ...
      <div className="flex flex-row items-end w-full">
        <div className="mt-10 ml-4 2xl:w-1/5 xl:w-1/5 lg:w-1/6 md:invisible md:0/6 w-0/6" />
        <Footer
          blog={userData?.blog}
