  ...
  return (
    <div className="bg-lm-light-grey dark:bg-dm-black-blue">
      ...
      <main className="min-w-screen min-h-screen flex flex-col justify-center items-center">
        <div className="flex flex-row justify-between items-center 2xl:w-4/12 xl:w-6/12 lg:w-7/12 md:w-8/12 w-11/12 md:mt-0 mt-4">
          <header className="dark:text-dm-white">devfinder</header>
          <LightDarkToggle />
        </div>
        <div className="mt-10 2xl:w-4/12 xl:w-6/12 lg:w-7/12 md:w-8/12 sm:w-8/12 w-11/12">
          <SearchBar handleSubmit={handleSubmit} noUser={noUser} />
        </div>
        <div className="mt-10 2xl:w-4/12 xl:w-6/12 lg:w-7/12 md:w-8/12 sm:w-8/12 w-11/12 h-4/6">
